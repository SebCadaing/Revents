...
export default function Navbar({ setFormOpen }: Props) {
  return (
    <header
      className="p-3 w-full fixed top-0 z-50 
    bg-gradient-to-r from-primary to-black"
    >
      <div
        className="flex align-middle
         items-center px-10 mx-auto gap-6"
      >
        <a
          className="max-h-16 text-white 
            flex items-center gap-3 border-r-white 
            border-r-2 pr-6"
        >
        ...
        <nav className="flex gap-3 my-2 uppercase text-lg text-white cursor-pointer">
          <a>Events</a>
